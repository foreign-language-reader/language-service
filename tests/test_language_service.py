...
def test_tagging(mocker):
    ...
    assert response.get_json() == [
        {'definitions': [], "lemma": "this", "tag": "DET", "token": "This"},
        {'definitions': [], "lemma": "be", "tag": "AUX", "token": "is"},
        {'definitions': [], "lemma": "a", "tag": "DET", "token": "a"},
        {'definitions': [], "lemma": "test", "tag": "NOUN", "token": "test"},
    ]
    assert response.status == "200 OK"
